...
if (!$addressData) {
    header("Location: addresses.php?error=not_found");
    exit;
}
...
$isDefault   = (int) $addressData['is_default'];
    ...
    if (empty($errors)) {
        ...
        try {
            ...
            if ($isDefault === 1) {
                ...
                if (!$stmt) {
                    throw new Exception(
                        "Unable to prepare default address query."
                    );
                }
            ...
            if (!$stmt) {
                throw new Exception(
                    "Unable to verify default address."
                );
            }
            ...
            if ($defaultCount === 0) {
                ...
                if (!$stmt) {
                    throw new Exception(
                        "Unable to restore default address."
                    );
                }
            ...
            header(
                "Location: addresses.php?updated=1"
            );
...
<head>
    ...
    <title>Edit Address | Medicine Aapki Gaw Mein</title>
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <p>
                    Modify the delivery details below.
                </p>
