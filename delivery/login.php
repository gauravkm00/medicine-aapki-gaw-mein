...
// ======================================
// ALREADY LOGGED-IN DELIVERY BOY
// ======================================
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($mobile === "" || $password === "") {
        ...
        $error =
            "Mobile number aur password dono required hain.";
        ...
        if ($stmt) {
            ...
            if ($result && $result->num_rows === 1) {
                ...
                elseif ($user['role'] !== 'delivery') {
                    ...
                    $error =
                        "Is account ko delivery panel access nahi hai.";
...
<title>
    Delivery Boy Login | Medicine Aapki Gaw Mein
</title>
    ...
    <div class="login-card">
        ...
        <div class="login-left">
            ...
            <p>
                ...
                Welcome to the delivery panel.
                Manage your assigned orders and
                deliver medicines to customers safely
                and on time.
